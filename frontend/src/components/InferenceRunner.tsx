                ...
                {!isRunning ? (
                    <div className="flex flex-col w-full gap-4">
                        ...
                        <div className="flex flex-row w-full gap-4 justify-start">
                            ...
                            <textarea className="ml-auto w-[80%] bg-dark-200 focus:border-primary-100 focus:ring-0 focus:shadow-none rounded-sm h-40 text-gray-400" id="query" placeholder="Enter a query..." />
                        </div>

                        <div className="flex flex-row w-full gap-4 justify-start">
                            <h3 className=" flex-grow font-semibold leading-none">Version</h3>
                            <div className=" items-baseline w-[80%]">
                                <Dropdown buttonText="Model Version">
                                    <DropdownItem name="0.1.0" />
                                    <DropdownItem name="0.2.0" />
                                    <DropdownItem name="0.3.0" />
                                </Dropdown>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-row w-full gap-4 justify-start">
                            <button className="px-3 py-1.5 bg-primary-100 rounded hover:bg-primary-500 ml-auto" onClick={() => setIsRunning(true)}>
                    ...
                    <div className="flex flex-col gap-2 w-full p-4 rounded bg-dark-200">
                        <div className=" flex flex-row ">
                            <h3 className=" font-semibold">Running Compleation Query</h3>
                        ...
                        <h3 className=" font-mono text-sm ">
                            This is the query a user entered. This will show the information that a user entered previously. This is the prompt. This is the query a user entered. This will show the information that a user entered previously. This is the prompt.
                        </h3>
