...
import worker_v1_pb2 as worker__v1__pb2
...
class WorkerManagerService(object):
    ...
    def Heartbeat(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/WorkerManagerService/Heartbeat',
    ...
    def WriteOutputChunk(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/WorkerManagerService/WriteOutputChunk',
    ...
    def CompleteJob(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/WorkerManagerService/CompleteJob',
