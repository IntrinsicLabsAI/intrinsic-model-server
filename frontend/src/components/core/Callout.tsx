...
export default function Callout({
    ...
    return (
        <div className={`flex flex-col w-full rounded-md p-4 ${color ? colorOptions[color] : colorOptions["blue"]}`}>
            <div className="flex flex-row gap-4 w-full h-full items-start">
                {icon && <div className=""><Icon icon={icon} size={20} color={"#252A31"}/></div> }
